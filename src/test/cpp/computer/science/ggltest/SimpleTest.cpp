...
log4cxx::LoggerPtr SimpleTest::logger = log4cxx::Logger::getLogger(std::string(
...
TEST_F(SimpleTest, testCase_ASSERT_simple)
{
    ...
    ASSERT_EQ(expectedResult, actualResult); // << "The optional description that will be displayed if this test
                                             // failed";
